...
import com.example.beachbuddy.SplashActivity.Companion
...
class FragmentLogin : Fragment() {
        ...
        binding.btnLogin.setOnClickListener {
            ...
            if(emailText.isEmpty() || passText.isEmpty()){
                ...
                if(Patterns.EMAIL_ADDRESS.matcher(emailText).matches()){
                    auth.signInWithEmailAndPassword(emailText,passText).addOnCompleteListener {
                        if(it.isSuccessful){
                            ...
                            Log.e(TAG,"Manual LogIN : $isLoggedin")
    ...
    private fun savePersonwithData(person : Person, email : String) = CoroutineScope(Dispatchers.IO).launch {
        try{
            ...
            Log.e(TAG, "Error while saving data : ${e.message}")
